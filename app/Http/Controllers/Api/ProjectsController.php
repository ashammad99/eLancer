...
//        return Project::query();
        ...
        return $entries;//Laravel Automcatically convert this collection to json
...
//        return new JsonResponse($project, 201);
    ...
    {
        //eager loading
//        return Project::query()->with('category')->find($id);
        //return $project->category;
//        return $project->load('category','tags:name','user') ;
