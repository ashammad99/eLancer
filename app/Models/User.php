...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    //by proposal, we can know the project which related to it
    ...
    //to return projects that applied by the user
    // can apply more than project
    //many-to-many relation, user can apply more than project and the project can be applied by more than use r
    public function proposedProjects()
    {
        return $this->belongsToMany(
            ...
            'proposals',
            'freelancer_id',
            'project_id'//f.k of related model
        )->withPivot([//addition to projects' data, return data of proposal(must exist in pivot table - proposals)
            'description', 'cost', 'duration', 'duration_unit', 'status',
        ]);
    }
    //to return projects that contracted by the user
    //one-to-many relation, user can contract more than project and the project can be applied by more than user
